    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 overflow-x-hidden">
      ...
      <nav className="fixed w-full z-50 bg-white/95 backdrop-blur-xl border-b border-gray-100/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between h-20 md:hidden relative">
            ...
            {/* Botão menu no canto direito */}
            <button
              onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
              className="absolute right-2 p-2 text-gray-700 hover:text-red-600"
            >
          ...
          {/* DESKTOP (md+) */}
          <div className="hidden md:grid md:grid-cols-[1fr_auto_1fr] items-center h-24">
            {/* Menu esquerdo */}
            <div className="flex items-center justify-start space-x-4 font-medium text-sm">
              <a
                href="#features"
                className="px-2 py-2 text-gray-600 hover:text-red-600 transition-colors"
              >
                Funcionalidades
              </a>
              <a
            ...
            {/* Menu direito */}
            <div className="flex items-center justify-end space-x-4 font-medium text-sm">
              <a
                href="#plans"
                className="px-2 py-2 text-gray-600 hover:text-red-600 transition-colors"
              >
              ...
              <a
                href="/login"
                className="inline-block bg-red-600 text-white px-6 py-2.5 rounded-xl font-bold hover:bg-red-700 transition-all shadow-md shadow-red-600/20 active:scale-95"
              >
                Entrar
              </a>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden fixed left-0 top-20 w-full bg-white border-b border-gray-100 p-4 space-y-3 shadow-lg font-medium z-40">
            <a
              href="#features"
              className="block px-4 py-3 text-gray-800 hover:bg-red-50 hover:text-red-600 rounded-lg text-center"
            >
              Funcionalidades
            </a>
            <a
            ...
            <a
              href="/login"
              className="block w-full text-center bg-red-600 text-white py-3 rounded-xl font-bold mt-1"
            >
              Entrar
            </a>
          </div>
      ...
      <footer className="bg-slate-950 text-slate-400 pt-20 pb-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-600">
          <p>© 2025 +Fôlego Tecnologia Esportiva Ltda.</p>
